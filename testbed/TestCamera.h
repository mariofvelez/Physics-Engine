...
public:
	...
	TestCamera(glm::vec3 pos, glm::vec3 front, glm::vec3 up) : m_pos(pos), m_front(front), m_up(up), view(1.0f), projection(1.0f), m_FOV(60.0f), speed(10.0f), pitch(0), near(0.1f), far(500.0f)
	{
